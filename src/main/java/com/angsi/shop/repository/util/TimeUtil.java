...
public class TimeUtil {
    ...
    public static long dateDiffMinute(Date beginDate, Date endDate) {
        ...
        long date1ms=beginDate.getTime();
        long date2ms=endDate.getTime();
        long difference =(date2ms-date1ms)/nm;
        return difference;
    }
     ...
     * @return
     */
    public static String startTimeFormat(String startTime){
        return StringUtils.isBlank(startTime)?startTime:startTime+" 00:00:00";
    }
     ...
     * @return
     */
    public static String endTimeFormat(String endTime){
        return StringUtils.isBlank(endTime)?endTime:endTime+" 23:59:59";
    }

    /**
     *  判断当前时间点是否在时间区间内
     * @param beginStr 开始时间点 7:00
     * @param endStr 结束时间点22:00
     * @author gaobin
     * @return
     * @throws ParseException
     */
